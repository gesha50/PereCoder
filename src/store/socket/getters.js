...
export function isGameRun (state) {
  return state.isGameRun
}

export function FOUR_GAME_WORDS (state) {
  return state.FOUR_GAME_WORDS
}

export function threeNumbers (state) {
  return state.threeNumbers
}

export function gameMessage (state) {
